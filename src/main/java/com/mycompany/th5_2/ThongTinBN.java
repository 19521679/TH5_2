 ...
 * @author Admin
 */
public class ThongTinBN extends javax.swing.JFrame {

    /**
     * Creates new form ThongTinBN
     */
    public ThongTinBN() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        txtTBN = new javax.swing.JTextField();
        ...
        txtTBN.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtTBNActionPerformed(evt);
            }
        });
                                        ...
                                        .addGroup(layout.createSequentialGroup()
                                                ...
                                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                                        ...
                                                        .addGroup(layout.createSequentialGroup()
                                                                ...
                                                                .addGap(18, 18, 18)
                                                                .addComponent(txtDT, javax.swing.GroupLayout.PREFERRED_SIZE, 157, javax.swing.GroupLayout.PREFERRED_SIZE))
                                                        .addGroup(layout.createSequentialGroup()
                ...
                layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        .addGroup(layout.createSequentialGroup()
                                ...
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                                        ...
                                        .addComponent(txtDT, javax.swing.GroupLayout.PREFERRED_SIZE, 22, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void txtTBNActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtTBNActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtTBNActionPerformed
    ...
    private void btnTActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnTActionPerformed
        // TODO add your handling code here:
        benhnhan.setMABN(txtMBN.getText());
        benhnhan.setTENBN(txtTBN.getText());
        benhnhan.setNGSINH(dateNGS.getDate());
        benhnhan.setDCHI(txtDC.getText());
        benhnhan.setDTHOAI(txtDT.getText());
        benhnhan.setGIOTINH(jComboBox1.getSelectedItem().equals("Nam") ? false : true);
        if (BenhNhanDAO.insertDatabase(benhnhan)) {
            JOptionPane.showMessageDialog(null, "Đã thêm bệnh nhân thành công", "Thông báo", 1);
            dispose();
        } else JOptionPane.showMessageDialog(null, "Thêm bệnh nhân không thành công", "Thông báo", 1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThongTinBN.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThongTinBN().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField txtTBN;
